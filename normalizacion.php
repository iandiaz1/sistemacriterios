...
foreach ($criteriosSeleccionados as $id) {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        $updateSql = "UPDATE criterios_tabla SET sumatoria = $sumatoria, ponderacion = $ponderacion, porcentaje = $porcentaje WHERE id = '$id'";
...
<body>
    ...
    <div class="normalizacion-container">
       ...
       <h2>Matriz de comparacíon de Criterios</h2>
